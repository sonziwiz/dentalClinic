...
<head>
  ...
  <title> SBJM Dental Clinic</title>
                ...
                <div class="p-5">
                  ...
                  <form class="user" method="POST" action="process.php">
                    <div class="form-group">
                      <input type="input" class="form-control form-control-user" id="user_email"  name="user_email" aria-describedby="emailHelp" placeholder="Enter Username or Email..">
                    </div>
                    <div class="form-group">
                      <input type="password" class="form-control form-control-user" id="user_pass" name="user_pass"  placeholder=" Enter your Password...">
                    </div> 
