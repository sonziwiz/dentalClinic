...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo web_root;?>" class="logo">
      ...
      <span class="logo-mini stretch-img"><b><img src="<?php echo web_root;?>/dist/img/logo2.png"></b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b> SBJM Dental Clinic</b></span>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?php echo web_root ;?>logout.php" class="btn btn-default btn-flat">Log out</a>
                </div>
              </li>
            </ul>
          </li>
 ...
 <div class="modal fade" id="menuModal" tabindex="-1">
  ...
  <footer class="main-footer no-print">
    <div class="pull-right hidden-xs">
      <b>Designed by team B</b> 
    </div>
    <strong> <a href="">SJBM DENTAL CLINIC</a>.</strong> &copy 2023 Project (Software Engr)
  </footer>
